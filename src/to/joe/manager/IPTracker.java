...
public class IPTracker {
	...
	/**
	 * Incoming player.
	 * Adds player to list if they match anyone.
	 * @param name
	 * @param IP
	 */
	...
	/**
	 * Get IPs matching currently collected names.
	 * Append to list
	 * @param names
	 * @param ips
	 * @return
	...
	/**
	 * Get Names matching currently collected IPs
	 * Append to list.
	 * @param names
	 * @param ips
	 * @return
	...
	/**
	 * When player actually joins
	 * Alert admins if matches banned players and isn't set to quietly join
	 * @param name
	 */
