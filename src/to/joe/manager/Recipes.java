...
public class Recipes {
    ...
    public void addRecipes() {
        ...
        // Diamond
        final ShapedRecipe bob = new ShapedRecipe(new ItemStack(Material.DIAMOND, 1));
        ...
        // Leaves
        final ShapedRecipe bob2 = new ShapedRecipe(new ItemStack(Material.LEAVES, 2));
        bob2.shape("  a", " b ", " c ");
        ...
        // Apple
        final ShapedRecipe bob3 = new ShapedRecipe(new ItemStack(Material.APPLE, 1));
        ...
        // Netherrack
        final ShapedRecipe bob4 = new ShapedRecipe(new ItemStack(Material.NETHERRACK, 1));
        ...
        // Glowstone Block
        final ShapedRecipe bob5 = new ShapedRecipe(new ItemStack(Material.GLOWSTONE, 20));
        ...
        // Web
        final ShapedRecipe bob6 = new ShapedRecipe(new ItemStack(Material.WEB, 1));
        bob6.shape("A A", " A ", "A A");
        bob6.setIngredient('A', Material.STRING);
        this.j2.getServer().addRecipe(bob6);
        // Soulsand
        final ShapedRecipe bob7 = new ShapedRecipe(new ItemStack(Material.SOUL_SAND, 20));
